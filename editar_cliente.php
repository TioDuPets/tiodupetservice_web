...
if(count($_POST) > 0) {
    ...
    if(empty($email) || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if($erro) {
            ...
            SET pet = '$pet', data_nascimento = '$data_nascimento', nome = '$nome', email = '$email', telefone = '$telefone', endereço = '$endereço'
            WHERE id = '$id'";
...
<body>
    <a href="/sistema/clientes.php">Voltar para a lista</a>
