    ...
    <body>
        ...
        if ($resultado != null)
            foreach ($resultado as $linha) {
                ...
                echo '<td><a href="excluir.php?id=' . $linha['id'] . '&nome=' . $linha['nome'] . '&sexo=' . $linha['sexo'] . '&especie=' . $linha['especie'] . '"><i class="fa fa-user-times w3-large w3-text-teal"></i> </a></td></td>';
                echo '<td><a href="atualizar.php?id=' . $linha['id'] . '&nome=' . $linha['nome'] . '&sexo=' . $linha['sexo'] . '&especie=' . $linha['especie'] . '"><i class="fa fa-refresh w3-large w3-text-teal""></i></a></td></td>';
                echo '</tr>';
            }
        echo ' 
       </table>
