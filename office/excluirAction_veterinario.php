...
if ($stmt->execute()) {
    echo json_encode(['status' => 'success', 'message' => 'Veterinário excluído com sucesso!']);
} else {
    echo json_encode(['status' => 'error', 'message' => 'Erro ao excluir o veterinário: ' . $stmt->error]);
}
