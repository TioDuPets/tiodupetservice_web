...
<body>
	...
	<div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-display-middle">
		<h1 class="w3-center w3-teal w3-round-large w3-margin">Atualizar Pet ID:
			<?php echo " " . $_GET['id'] ?>
		</h1>
		<form action="atualizarAction.php" class="w3-container" method='post'>
			...
			<input name="txtsexo" class="w3-input w3-light-grey w3-border" value="<?php echo $_GET['sexo'] ?>">
			<br>
			<label class="w3-text-teal" style="font-weight: bold;">Espécie</label>
			<input name="txtespecie" class="w3-input w3-light-grey w3-border" value="<?php echo $_GET['especie'] ?>">
			<br>
