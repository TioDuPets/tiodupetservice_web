...
<body>
	...
	<div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-display-middle">
		...
		<form action="excluirAction.php" class="w3-container w" method='post'>
			...
			<input name="txtApelido" class="w3-input w3-border w3-grey" disabled value="<?php echo $_GET['sexo'] ?>">
			<br>
			<label class="w3-text-teal" style="font-weight: bold;">Espécie</label>
			<input name="txtEmail" class="w3-input w3-border w3-grey" disabled value="<?php echo $_GET['especie'] ?>">
			<br>
